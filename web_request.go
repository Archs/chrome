...
func (w *WebRequest) OnBeforeRequest(callback func(details js.M)) {
...
func (w *WebRequest) OnBeforeSendHeaders(callback func(details js.M)) {
...
func (w *WebRequest) OnSendHeaders(callback func(details js.M)) {
...
func (w *WebRequest) OnHeadersReceived(callback func(details js.M)) {
...
func (w *WebRequest) OnAuthRequired(callback func(details js.M)) {
...
func (w *WebRequest) OnResponseStarted(callback func(details js.M)) {
