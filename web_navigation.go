...
func (w *WebNavigation) GetFrame(details js.M, callback func(details js.M)) {
	w.o.Call("getFrame", details, callback)
}

// GetAllFrames retrieves information about all frames of a given tab.
func (w *WebNavigation) GetAllFrames(details js.M, callback func(details []js.M)) {
...
func (w *WebNavigation) OnBeforeNavigate(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnCommited(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnDOMContentLoaded(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnCompleted(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnErrorOccurred(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnCreatedNavigationTarget(callback func(details js.M), filters map[string][]js.M) {
...
// use the updated URL.
func (w *WebNavigation) OnReferenceFragmentUpdated(callback func(details js.M), filters map[string][]js.M) {
...
func (w *WebNavigation) OnTabReplaced(callback func(details js.M)) {
...
func (w *WebNavigation) OnHistoryStateUpdated(callback func(details js.M), filters map[string][]js.M) {
