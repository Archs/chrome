...
$packages["github.com/Archs/chrome/api/tabs"] = (function() {
	var $pkg = {}, $init, chrome, js, Tab, ptrType, tabs;
	chrome = $packages["github.com/Archs/chrome"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	Tab = $pkg.Tab = $newType(0, $kindStruct, "tabs.Tab", "Tab", "github.com/Archs/chrome/api/tabs", function(Object_, Id_, Index_, WindowId_, OpenerTabId_, Selected_, Highlighted_, Active_, Pinned_, Url_, Title_, FavIconUrl_, Status_, Incognito_, Width_, Height_, SessionId_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.Id = 0;
...
$packages["github.com/Archs/chrome/api/runtime"] = (function() {
	var $pkg = {}, $init, chrome, tabs, js, MessageSender, funcType, funcType$6, ptrType, runtime, OnMessage;
	chrome = $packages["github.com/Archs/chrome"];
	tabs = $packages["github.com/Archs/chrome/api/tabs"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	MessageSender = $pkg.MessageSender = $newType(0, $kindStruct, "runtime.MessageSender", "MessageSender", "github.com/Archs/chrome/api/runtime", function(Object_, tab_, FrameId_, Id_, Url_, TlsChannelId_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.Object = null;
			this.tab = new tabs.Tab.ptr();
			this.FrameId = 0;
			this.Id = "";
			this.Url = "";
			this.TlsChannelId = "";
	...
	funcType$6 = $funcType([$emptyInterface, MessageSender, funcType], [], false);
	ptrType = $ptrType(js.Object);
	OnMessage = function(callback) {
		var $ptr, callback;
		runtime.onMessage.addListener($externalize(callback, funcType$6));
	};
	$pkg.OnMessage = OnMessage;
	MessageSender.init([{prop: "Object", name: "", pkg: "", typ: ptrType, tag: ""}, {prop: "tab", name: "tab", pkg: "github.com/Archs/chrome/api/runtime", typ: tabs.Tab, tag: "js:\"tab\""}, {prop: "FrameId", name: "FrameId", pkg: "", typ: $Int, tag: "js:\"frameId\""}, {prop: "Id", name: "Id", pkg: "", typ: $String, tag: "js:\"id\""}, {prop: "Url", name: "Url", pkg: "", typ: $String, tag: "js:\"url\""}, {prop: "TlsChannelId", name: "TlsChannelId", pkg: "", typ: $String, tag: "js:\"tlsChannelId\""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = chrome.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
...
$packages["main"] = (function() {
	var $pkg = {}, $init, runtime, js, mapType, main;
	runtime = $packages["github.com/Archs/chrome/api/runtime"];
	js = $packages["github.com/gopherjs/gopherjs/js"];
	mapType = $mapType($String, $emptyInterface);
	main = function() {
		var $ptr;
		runtime.OnMessage((function $b(message, sender, sendResponse) {
			var $ptr, _key, _map, message, resp, sendResponse, sender, $s, $r;
			/* */ $s = 0; var $f, $c = false; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $ptr = $f.$ptr; _key = $f._key; _map = $f._map; message = $f.message; resp = $f.resp; sendResponse = $f.sendResponse; sender = $f.sender; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
			console.log("Runtime.OnMessage received: ", $assertType(message, mapType), sender);
			resp = (_map = new $Map(), _key = "farewell", _map[_key] = { k: _key, v: new $String("goodbye") }, _map);
			$r = sendResponse(new js.M(resp)); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
			/* */ $s = -1; case -1: } return; } if ($f === undefined) { $f = { $blk: $b }; } $f.$ptr = $ptr; $f._key = _key; $f._map = _map; $f.message = message; $f.resp = resp; $f.sendResponse = sendResponse; $f.sender = sender; $f.$s = $s; $f.$r = $r; return $f;
		}));
	};
	$init = function() {
		$pkg.$init = function() {};
