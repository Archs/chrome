...
func (i *Ime) SetComposition(parameters js.M, callback func(success bool)) {
...
func (i *Ime) ClearComposition(parameters js.M, callback func(success bool)) {
	i.o.Call("clearComposition", parameters, callback)
}

// CommitText commits the provided text to the current input.
func (i *Ime) CommitText(parameters js.M, callback func(success bool)) {
...
func (i *Ime) SendKeyEvents(parameters js.M, callback func()) {
...
func (i *Ime) SetCandidateWindowProperties(parameters js.M, callback func(success bool)) {
...
func (i *Ime) SetCandidates(parameters js.M, callback func(success bool)) {
...
func (i *Ime) SetCursorPosition(parameters js.M, callback func(success bool)) {
...
func (i *Ime) OnSurroundingTextChanged(callback func(engineID string, surroundingInfo js.M)) {
